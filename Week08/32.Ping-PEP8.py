...
def main():
    ...
    print('    Minimum = %dms, Maximum = %dms, Average = %dms' %
          (find_time(attemp1, attemp2, attemp3, attemp4, 1),
           find_time(attemp1, attemp2, attemp3, attemp4, 2),
           find_time(attemp1, attemp2, attemp3, attemp4, 3)))
    # print(error_cal)
...
def find_time(line1, line2, line3, line4, return_val):
    '''find time'''
    time_all = ''
    time_all += sub_find_time(line1)+','+sub_find_time(line2) + \
        ','+sub_find_time(line3)+','+sub_find_time(line4)
    ...
    if return_val == 1:
        return find_min(time_without_zero, avg)
    elif return_val == 2:
        return find_max(time_without_zero)
    elif return_val == 3:
        return avg
